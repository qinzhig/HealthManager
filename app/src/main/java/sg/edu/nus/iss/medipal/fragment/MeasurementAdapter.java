...
import sg.edu.nus.iss.medipal.fragment.MeasurementFragment.OnListFragmentInteractionListener;
...
public class MeasurementAdapter extends RecyclerView.Adapter<MeasurementAdapter.ViewHolder> {
    ...
    public MeasurementAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onMeasurementSelected(holder.mItem);
                }
            }
        });
    }
